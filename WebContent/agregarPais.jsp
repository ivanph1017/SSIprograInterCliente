...
<body>
	<h4 class="section-titulo">Gestión de Paises / Agregar Pais</h4>
	<form id="postPais" action="pais" method="post">
		<div class="row">
			...
			<div class="form-group col-md-4" style="">
				<label for="poblacion">Población</label> <input type="number"
					...
					placeholder="Escribir poblacion" name="poblacion">
			</div>
			<div class="form-group col-md-4" style="">
				<label for="pbi">PBI</label> <input type="text" class="form-control"
					id="pbi" placeholder="Escribir pbi" name="pbi">
			</div>
		</div>
		<div>
